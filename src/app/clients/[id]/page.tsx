...
export default function Client360Page() {
  ...
  const activities = allActivities.filter((a) => a.clientId === id);
  const allContracts = useOS((s) => s.contracts);
  const contracts = allContracts.filter((c) => c.clientId === id);
